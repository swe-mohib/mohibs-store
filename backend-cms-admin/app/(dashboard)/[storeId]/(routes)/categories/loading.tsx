  ...
  return (
    <div className="flex-col">
      <div className="flex-1 space-y-4 p-8 pt-6">
        {/* Page heading */}
        <Heading title="Categories" description="Loading categories..." />
        <Separator />

        {/* Toolbar (search/filter/add button area) */}
          ...
          <CardContent>
            <div className="space-y-3">
              {[...Array(5)].map((_, i) => (
                ...
                >
                  <Skeleton className="h-4 w-40" /> {/* Category name */}
                  <Skeleton className="h-4 w-32" /> {/* Billboard label */}
